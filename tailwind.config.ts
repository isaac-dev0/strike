  ...
  theme: {
    ...
    extend: {
      colors: {
		...
		status: {
		  received: {
			DEFAULT: "hsl(var(--received))",
			foreground: "hsl(var(--received-foreground))",
		  },
		  accepted: {
		  ...
		  declined: {
			DEFAULT: "hsl(var(--declined))",
			foreground: "hsl(var(--declined-foreground))",
		  },
		  "in-progress": {
		  ...
		  collected: {
			DEFAULT: "hsl(var(--collected))",
			foreground: "hsl(var(--collected-foreground))",
		  },
		},
        chart: {
          "1": "hsl(var(--chart-1))",
